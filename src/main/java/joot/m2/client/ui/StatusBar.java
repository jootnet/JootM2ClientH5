...
public final class StatusBar extends WidgetGroup {
	...
	private boolean initializeComponents() {
		...
		if (App.ChrPrivate.exp == 0) {
			...
			imgProgressExp
					.setDrawable(new TextureRegionDrawable(new TextureRegion(texs[texIdx_Prguse7], 0, 0, progressWidth, 13)));
		...
		if (App.ChrBasic.hp == 0) {
			...
			imgProgressHp.setDrawable(new TextureRegionDrawable(new TextureRegion(texs[texIdx_Prguse4], 0, 0, 42, 90)));
			imgProgressHp.setSize(42, 90);
		} else {
			int progressHeight = (int) (90 * ((float) App.ChrBasic.hp / App.ChrBasic.maxHp));
			imgProgressHp.setDrawable(
					new TextureRegionDrawable(new TextureRegion(texs[texIdx_Prguse4], 0, 0, 42, progressHeight)));
