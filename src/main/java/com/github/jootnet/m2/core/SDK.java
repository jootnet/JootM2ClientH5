...
public final class SDK {
	 ...
	 */
	public static native Uint8Array unzip(ArrayBuffer ziped) throws JavaScriptException/*-{
															var ret = new $wnd.Zlib.Inflate(new Uint8Array(ziped)).decompress();
															return ret;
															}-*/;
	 ...
	 * @throws JavaScriptException
	 */
	public static native Uint8Array unzip(ArrayBuffer ziped, int offset) throws JavaScriptException/*-{
		var ret = new $wnd.Zlib.Inflate(new Uint8Array(ziped, offset)).decompress();
		return ret;
	}-*/;
